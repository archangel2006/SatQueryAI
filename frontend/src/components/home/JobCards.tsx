...
const JOBS: JobCardDef[] = [
  ...
  },
  {
    ...
    to: ROUTES.change,
    image: '/missions/before-vs-after.png',
  },
  {
    n: '03',
    ...
    to: ROUTES.cloud,
    image: '/missions/see-thru-cloud.png',
  },
]

// function JobArt({ kind }: { kind: JobCardDef['image'] }) {
//   if (kind === 'ask') {
//     return (
    ...
    <div className="grid gap-5 lg:grid-cols-3">
      {JOBS.map((job, index) => (
        ...
        >
          <Link
            to={job.to}
            className={`group relative flex h-full flex-col overflow-hidden rounded-2xl border no-underline transition-shadow duration-300 hover:-translate-y-0.5 hover:shadow-[0_20px_40px_-24px_rgba(232,93,4,0.55)] ${job.live
          ...
          >
            ...
            <div className="flex flex-1 flex-col p-5 pt-3">
              ...
              <span
                className={`mt-4 inline-flex items-center gap-1 text-sm font-semibold ${job.live ? 'text-accent' : 'text-muted'
                  }`}
              >
